          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                High-frequency hardware telemetry, rolling CPU/RAM waveforms, and microservices status for <strong className="text-white">169.58.227.157</strong> (icandothat.online)
              </p>
            </div>
          </div>
        </div>
